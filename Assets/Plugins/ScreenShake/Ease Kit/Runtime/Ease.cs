...
public static class Ease
{
    ...
    /// <summary>
    /// Applies an easing function to the input value <paramref name="x"/> based on the specified easing <paramref name="type"/>.
    /// </summary>
    /// <param name="x">The input value to evaluate, typically in the range [0, 1].</param>
    /// <param name="type">The type of easing function to apply. Supported types include In, Out, and InOut variants of Expo, Back, Sine, Cubic, Quint, Circ, Elastic, Quad, and Quart.</param>
    /// <returns>The result of the easing function applied to <paramref name="x"/>. Returns <paramref name="x"/> unchanged if the type is unrecognized.</returns>
    ...
    /// <summary>
    /// Returns a delegate representing the easing function corresponding to the specified <paramref name="type"/>.
    /// </summary>
    /// <param name="type">
    /// The type of easing function to retrieve. Supported types include In, Out, and InOut variants of:
    /// Expo, Back, Sine, Cubic, Quint, Circ, Elastic, Quad, and Quart.
    /// </param>
    /// <returns>
    /// A <see cref="System.Func{Single, Single}"/> delegate that takes a float input and returns the eased output.
    /// </returns>

...
public class ScreenShake : CinemachineExtension
{
    ...
    public static ScreenShake i { get; private set; }
    ...
    private void Awake()
    {
        if (i == null)
            ...
            Debug.LogWarning("Multiple ScreenShake instances detected! Destroying the new one.");
            Destroy(this);
        }
    }
    ...
    public static implicit operator bool(ScreenShake instance) => instance != null;
